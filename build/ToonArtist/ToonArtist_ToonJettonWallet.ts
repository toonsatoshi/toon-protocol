...
export function dictValueParserToonArtist$Data(): DictionaryValue<ToonArtist$Data> {
 ...
 type ToonJettonWallet_init_args = {
    $$type: 'ToonJettonWallet_init_args';
    balance: bigint;
    owner: Address;
    master: Address;
...
function initToonJettonWallet_init_args(src: ToonJettonWallet_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeCoins(src.balance);
        b_0.storeAddress(src.owner);
...
async function ToonJettonWallet_init(balance: bigint, owner: Address, master: Address) {
    const __code = Cell.fromHex('');
    const builder = beginCell();
    initToonJettonWallet_init_args({ $$type: 'ToonJettonWallet_init_args', balance, owner, master })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

export const ToonJettonWallet_errors = {
...
export const ToonJettonWallet_errors_backward = {
    "Stack underflow": 2,
    "Stack overflow": 3,
    "Integer overflow": 4,
...
const ToonJettonWallet_types: ABIType[] = [
...
const ToonJettonWallet_getters: ABIGetter[] = [
    {"name":"balance","methodId":104128,"arguments":[],"returnType":{"kind":"simple","type":"int","optional":false,"format":257}},
    {"name":"owner","methodId":83229,"arguments":[],"returnType":{"kind":"simple","type":"address","optional":false}},
]

export const ToonJettonWallet_getterMapping: { [key: string]: string } = {
    'balance': 'getBalance',
    'owner': 'getOwner',
}

const ToonJettonWallet_receivers: ABIReceiver[] = [
...
export class ToonJettonWallet implements Contract {
    
    public static readonly storageReserve = 0n;
    public static readonly MIN_STAKE = 100000000000n;
    public static readonly TOON_DROP_THRESHOLD = 1000n;
    public static readonly errors = ToonJettonWallet_errors_backward;
    public static readonly opcodes = ToonJettonWallet_opcodes;
    
    static async init(balance: bigint, owner: Address, master: Address) {
        return await ToonJettonWallet_init(balance, owner, master);
    }
    
    static async fromInit(balance: bigint, owner: Address, master: Address) {
        const __gen_init = await ToonJettonWallet_init(balance, owner, master);
        const address = contractAddress(0, __gen_init);
        return new ToonJettonWallet(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new ToonJettonWallet(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  ToonJettonWallet_types,
        getters: ToonJettonWallet_getters,
        receivers: ToonJettonWallet_receivers,
        errors: ToonJettonWallet_errors,
    };
